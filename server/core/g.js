...
module.exports = function () {
    ...
    me.base64_encode = function(unencoded) {
        return new Buffer(unencoded || '').toString('base64');
    };
    
    me.base64_decode = function(encoded) {
    ...
    me.unserialize = function (data) {
        ...
        // +     improved by: Chris
        // +     improved by: James
        // +     improved by Alexander Kindziora (added node js support)
        ...
        var _unserialize = function (data, offset) {
            ...
            switch (dtype) {
                ...
                case 's':
                    ...
                    readdata = readdata.toString("utf8");
                    break;
                case 'a':
                    readdata = {};
